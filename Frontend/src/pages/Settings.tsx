      ...
      {activeTab === 'profile' && (
        <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="text-gray-900 font-medium">{profileData.soilType || t('common.notSet')}</p>
                    )}
                  </div>
                </div>
                ...
                {isEditing && (
                  <div className="flex gap-3 pt-4">
                    <button
                      ...
                      title={!profileData.name?.trim() ? 'Name is required' : ''}
                    >
                      {saving ? (
                        <>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {mockFarms.map((farm) => (
                <div key={farm.id} className="p-4 bg-primary-50 rounded-lg">
                  <h3 className="font-bold text-gray-900 mb-2">{farm.name}</h3>
      ...
      {activeTab === 'preferences' && (
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{t('settings.dataRetention')}</label>
                <select
