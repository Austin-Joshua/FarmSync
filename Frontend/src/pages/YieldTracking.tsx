...
const YieldTracking = () => {
  ...
  const chartData = yields.map((yield_) => ({
    name: getCropName(yield_.cropId),
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Chart */}
      <div className="card">
        <h2 className="text-xl font-bold text-gray-900 mb-4">{t('yield.title')} {t('common.by')} {t('yield.crop')}</h2>
      ...
      {/* Yield Records */}
      <div className="card">
        <h2 className="text-xl font-bold text-gray-900 mb-4">{t('yield.title')} {t('common.records')}</h2>
