...
export const MicrosoftSignIn: React.FC<OAuthLoginProps> = () => {
  const handleMicrosoftLogin = useCallback(() => {
    toast.loading('Redirecting to Microsoft...', { duration: 2000 });
    window.location.href = `${BACKEND_ORIGIN}/oauth2/authorization/microsoft`;
  }, []);
...
export const OAuthSignIn: React.FC<OAuthLoginProps> = () => {
  return (
